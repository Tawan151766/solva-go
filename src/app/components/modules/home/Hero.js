    ...
    <section className="@container @[480px]:p-4">
      ...
      >
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          <button className="h-10 @[480px]:h-12 px-4 @[480px]:px-5 rounded-lg bg-[#f0c674] text-[#0d1117] text-sm @[480px]:text-base font-bold hover:bg-[#ffd700] transition-colors">Experience Luxury</button>
