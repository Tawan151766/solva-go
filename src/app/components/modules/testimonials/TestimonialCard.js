      ...
      >
        <div className="flex w-full items-end justify-between gap-4 p-6">
          <div className="flex max-w-[440px] flex-1 flex-col gap-3">
            <blockquote className="text-[#f0c674] text-xl font-bold leading-tight">
              "{testimonial.quote}"
            </blockquote>
            <cite className="text-[#f0c674]/90 text-base font-medium leading-normal not-italic">
              {testimonial.name}
              <span className="block text-[#f0c674]/80 text-sm font-normal">
                {testimonial.role}
              </span>
            </cite>
          </div>
